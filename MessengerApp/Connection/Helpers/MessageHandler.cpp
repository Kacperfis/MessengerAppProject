...
void MessageHandler::handleMessage(const Message& message, const std::shared_ptr<interface::IEncryptionManager>& encryptionManager) noexcept
{
...
void MessageHandler::handleStandardMessage(const Message& message, const std::shared_ptr<interface::IEncryptionManager>& encryptionManager) noexcept
{
